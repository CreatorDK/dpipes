...
class ClientTest13Class : public ClientTest {
public:
	ClientTest13Class(TestRegistrationClient registration) :
...
private:
	...
	static void SendRequestSync(DPClient* dlclient, ClientTest13Class* test) {
		wstringstream ss;
	...
	static void SendRequestAsync(DPClient* dlclient, ClientTest13Class* testClassPtr) {
...
TestRegistrationClient ClientTest13() {
	...
	registration.createHandler = [registration]() { return new ClientTest13Class(registration); };
	return registration;
}