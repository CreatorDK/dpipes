...
class ServerTest11Class : public ServerTest {
public:
	ServerTest11Class(TestRegistrationServer registration) :
...
public:
	void Execute(start_params_server& params) override {
		...
		_dpserver = new DPServer(_dpipe, false);
...
TestRegistrationServer ServerTest11() {
	...
	registration.createHandler = [registration]() { return new ServerTest11Class(registration); };
	return registration;
}