...
class ServerTest5Class : public ServerTest {
public:
	ServerTest5Class(TestRegistrationServer registration) :
...
TestRegistrationServer ServerTest5() {
	...
	registration.createHandler = [registration]() { return new ServerTest5Class(registration); };
	return registration;
}