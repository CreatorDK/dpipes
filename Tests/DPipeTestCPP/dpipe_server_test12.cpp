...
class ServerTest12Class : public ServerTest {
public:
	ServerTest12Class(TestRegistrationServer registration) :
...
TestRegistrationServer ServerTest12() {
	...
	registration.createHandler = [registration]() { return new ServerTest12Class(registration); };
	return registration;
}