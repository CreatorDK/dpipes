...
{
    [ClientTest("Test11", "DPServer - sync, DPClient - sync", "Description: Testing DPServer and DPClient communication", true)]
    public class ClientTest11 : ClientTestBaseClass
    {
        public ClientTest11(string testName, string title, string description) : base(testName, title, description) { }
        ...
        {
            if (data != null && data.Length > 0 && _dpclient != null)
            {
        ...
        public override void Execute(StartParamsClient startParams)
        {
            ...
            _dpclient = new DPClient(_dpipe, false, Encoding.Unicode);
