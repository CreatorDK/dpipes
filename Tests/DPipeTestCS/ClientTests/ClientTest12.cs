...
{
    [ClientTest("Test12", "DPServer - sync, DPClient - async", "Description: Testing DPServer and DPClient communication", true)]
    public class ClientTest12 : ClientTestBaseClass
    {
        public ClientTest12(string testName, string title, string description) : base(testName, title, description) { }
