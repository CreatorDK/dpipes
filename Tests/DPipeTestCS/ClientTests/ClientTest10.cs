...
{
    [ClientTest("Test10", "DPipeMessanger (Unicode) server - async, client - async", "Description: Testing scenario when DPipeMessanger server and client handling messages in async mode", true)]
    public class ClientTest10 : ClientTestBaseClass
    {
