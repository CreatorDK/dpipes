...
{
    [ClientTest("Test7", "DPipeMessanger (Unicode) server - sync, client - sync", "Description: Testing scenario when DPipeMessanger server and client handling messages in sync mode", true)]
    public class ClientTest07 : ClientTestBaseClass
    {
