...
{
    [ClientTest("Test13", "DPServer - async, DPClient - sync", "Description: Testing DPServer and DPClient communication", true)]
    public class ClientTest13 : ClientTestBaseClass
    {
        public ClientTest13(string testName, string title, string description) : base(testName, title, description) { }
