...
{
    [ClientTest("Test5", "DPipeMessanger (UTF-8) server - async, client - sync", "Description: Testing scenario when DPipeMessanger server in async mode and client in sync mode", true)]
    public class ClientTest05 : ClientTestBaseClass
    {
