...
{
    [ServerTest("Test13", "DPServer - async, DPClient - sync", "Description: Testing DPServer and DPClient communication", true)]
    public class ServerTest13 : ServerTestBaseClass
    {
        public ServerTest13(string testName, string title, string description) : base(testName, title, description) { }
        ...
        public override void Execute(StartParamsServer startParams)
        {
            ...
            _dpserver = new DPServer(_dpipe, true, Encoding.Unicode);
