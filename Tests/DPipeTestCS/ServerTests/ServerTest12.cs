...
{
    [ServerTest("Test12", "DPServer - sync, DPClient - async", "Description: Testing DPServer and DPClient communication", true)]
    public class ServerTest12 : ServerTestBaseClass
    {
        public ServerTest12(string testName, string title, string description) : base(testName, title, description) { }
